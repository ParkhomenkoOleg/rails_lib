...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference("Library.count") do
      post libraries_url, params: { library: { adress: @library.adress, name: @library.name } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { adress: @library.adress, name: @library.name } }
